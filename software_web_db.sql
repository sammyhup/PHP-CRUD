...
INSERT IGNORE INTO `cliente` (`id`, `nome`, `cpf`, `data_nascimento`, `telefone`, `genero`, `endereco`, `ativo`) VALUES
	(1, 'Antonia X', '401200108600', '2005-04-04', '1498764567', 'F', 'Rua Maravilhosa', 1);
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=latin1 COMMENT='Tabela que armazenará os dados de cadastro de usuário.';

-- Copiando dados para a tabela software_web_db.usuario: ~2 rows (aproximadamente)
INSERT IGNORE INTO `usuario` (`id`, `nome`, `cpf`, `data_nascimento`, `genero`, `cep`, `logradouro`, `numero_residencia`, `complemento`, `bairro`, `cidade`, `estado`, `codigo_area`, `numero_celular`, `email`, `senha`, `ativo`) VALUES
	...
	(7, 'Vitor Batista Fogar', '40120010860', '2000-04-24', 'M', '18609321', 'Rua Xis', '10', '', 'Bois Manso', 'Botucatu', 'SP', '+55', '11951008920', 'vitorfogar73@gmail.com', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 1);
